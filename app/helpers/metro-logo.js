...
const red = ['проспект ветеранов', 'ленинский проспект', 'автово', 'кировский завод', 'нарвская', 'балтийская', 'технологический институт 1', 'пушкинская', 'владимирская', 'площадь восстания', 'чернышевская', 'площадь ленина', 'выборгская', 'лесная', 'площадь мужества', 'политехническая', 'академическая', 'гражданский проспект', 'девяткино'];
...
export function metroLogo(params/*, hash*/) {
  ...
  if (red.indexOf(name) > -1) 
    return '<span class=\'metro-red\'>' + params + '<\/span>';
  if (blue.indexOf(name) > -1)
    return '<span class=\'metro-blue\'>' + params + '<\/span>';
  if (green.indexOf(name) > -1)
    return '<span class=\'metro-green\'>' + params + '<\/span>';
  if (orange.indexOf(name) > -1)
    return '<span class=\'metro-orange\'>' + params + '<\/span>';
  if (violet.indexOf(name) > -1)
    return '<span class=\'metro-violet\'>' + params + '<\/span>';
  return '<span class=\'railway\'>' + params + '<\/span>';
}
