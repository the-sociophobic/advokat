...
const red = ['проспект ветеранов', 'ленинский проспект', 'автово', 'кировский завод', 'нарвская', 'балтийская', 'технологический институт 1', 'пушкинская', 'владимирская', 'площадь восстания', 'чернышевская', 'выборгская', 'лесная', 'площадь мужества', 'политехническая', 'академическая', 'гражданский проспект', 'девяткино'];
