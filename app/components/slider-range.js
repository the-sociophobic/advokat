...
export default Ember.Component.extend({
  ...
  actions: {
    ...
    minValueMouseMove() {
      ...
      if (mousePercent < 0 || mousePercent > this.get('maxPos') - this.get('step')/ (this.get('max') - this.get('min'))) { return; }
    ...
    maxValueMouseMove() {
      ...
      if (mousePercent > 1 || mousePercent < this.get('minPos') + this.get('step') / (this.get('max') - this.get('min'))) { return; }
